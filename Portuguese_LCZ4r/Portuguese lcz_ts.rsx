...
#' Time_frequency: Define a resolução temporal para média. Padrão é "hora". Resoluções suportadas: "dia", "semana", "mês" ou "ano". Opções personalizadas como "3 dias", "2 semanas", etc.
