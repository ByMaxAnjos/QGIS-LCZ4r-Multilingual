...
#'      :Note de format: Le format date-heure doit suivre les conventions R, comme <b style='text-decoration: underline;'>2023-03-13 11:00:00</b> ou <b style='text-decoration: underline;'>2023-03-13</b>. Formats acceptés: "1/2/1999" ou "JJ/MM/AAAA", "1999-02-01".</p><p>
...
#' Date_start: Date de début au format <b>JJ/MM/AAAA</b>. Ex: 01-09-1986.
...
#'      :2. <b>deux.étapes</b>: Filtre les stations en zones LCZ hétérogènes. Requiert ≥80% de pixels concordants dans un noyau 5×5 (Daniel et al., 2017). Réduit le nombre de stations.</p><p>
...
#' LCZ_interpolation: Si TRUE (défaut), utilise l'interpolation LCZ. Si FALSE, interpolation conventionnelle sans LCZ.
#' Output: Raster au format GeoTIF de terra.
#' ALG_DESC: Cette fonction génère une représentation graphique des anomalies thermiques pour différentes Zones Climatiques Locales (LCZ).</p><p>
#'         :Plus d'infos: <a href='https://bymaxanjos.github.io/LCZ4r/articles/local_func_modeling.html#interpolating-thermal-anomalies-with-lcz'>Fonctions Locales LCZ (Interpolation des anomalies thermiques avec LCZ)</a>.
