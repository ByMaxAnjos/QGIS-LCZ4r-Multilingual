...
#'      :Nota de formato: El formato fecha-hora debe seguir convenciones R, como <b style='text-decoration: underline;'>2023-03-13 11:00:00</b> o <b style='text-decoration: underline;'>2023-03-13</b>. Formatos aceptados: "1/2/1999" o "DD/MM/AAAA", "1999-02-01".</p><p>
...
#' Date_start: Fecha de inicio en formato <b>DD/MM/AAAA</b>. Ej: 01-09-1986.
...
#'      :2. <b>dos.pasos</b>: Filtra estaciones en áreas LCZ heterogéneas. Requiere ≥80% de píxeles concordantes en kernel 5×5 (Daniel et al., 2017). Reduce número de estaciones.</p><p>
...
#' LCZ_interpolation: Si TRUE (por defecto), usa enfoque LCZ. Si FALSE, interpolación convencional sin LCZ.
#' Output: Raster en formato GeoTIF de terra.
#' ALG_DESC: Esta función genera una representación gráfica de anomalías térmicas para diferentes Zonas Climáticas Locales (LCZ).</p><p>
#'         :Más información: <a href='https://bymaxanjos.github.io/LCZ4r/articles/local_func_modeling.html#interpolating-thermal-anomalies-with-lcz'>Funciones Locales LCZ (Interpolación de anomalías térmicas con LCZ)</a>.
