...
##Karte der LCZ-Lufttemperatur=name
##pass_filenames
...
##QgsProcessingParameterRasterDestination|Output|Karte speichern
...
#'      :Hinweis zur Formatierung: Das Datums-/Zeitformat muss R-Konventionen entsprechen, z.B. <b style='text-decoration: underline;'>2023-03-13 11:00:00</b> oder <b style='text-decoration: underline;'>2023-03-13</b>. Auch Formate wie "1/2/1999" oder "YYYY-mm-dd", "1999-02-01" sind möglich.</p><p>
...
#'      :2. <b>zweistufig</b>: Weist LCZs zu Stationen zu, während solche in heterogenen LCZ-Bereichen herausgefiltert werden. Erfordert, dass mindestens 80% der Pixel innerhalb eines 5×5-Kerns mit dem LCZ des Mittelpunktes übereinstimmen (Daniel et al., 2017). Reduziert die Anzahl der Stationen. Wird oft in ultra- und hochdichten Beobachtungsnetzen verwendet.</p><p>
...
#' LCZ_interpolation: Wenn TRUE (Standard), wird die LCZ-Interpolation verwendet. Bei FALSE konventionelles Kriging ohne LCZ.
#' Output: Ein Raster im terra GeoTIF-Format.
#' ALG_DESC: Diese Funktion erzeugt eine räumliche Interpolation der Lufttemperatur (oder anderer Variablen) unter Verwendung von LCZ und Kriging.</p><p>
#'         :Weitere Informationen: <a href='https://bymaxanjos.github.io/LCZ4r/articles/local_func_modeling.html'>LCZ Lokale Funktionen (Temperaturmodellierung mit LCZ)</a> 
