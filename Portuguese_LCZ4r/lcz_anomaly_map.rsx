...
#'      :2. <b>dois.passos</b>: Filtra estações em áreas LCZ heterogêneas. Requer ≥80% de pixels concordantes em kernel 5×5 (Daniel et al., 2017). Reduz número de estações.</p><p>
...
#' LCZ_interpolation: Se TRUE (padrão), usa abordagem LCZ. Se FALSE, interpolação convencional sem LCZ.
...
#'         :Mais informações: <a href='https://bymaxanjos.github.io/LCZ4r/articles/local_func_modeling.html#interpolating-thermal-anomalies-with-lcz'>Funções Locais LCZ (Interpolação de anomalias térmicas com LCZ)</a>.
