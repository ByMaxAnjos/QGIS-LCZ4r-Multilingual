...
#' City: Uma variável textual do tipo "String", com nome da cidade ou área nos EUA continentais (baseado em <a href='https://nominatim.openstreetmap.org/ui/search.html'>OpenStreetMap</a>).</p><p>Exemplo: <b>Chicago</b>. Se o parâmetro estiver vazio, usa uma Região de Interesse (ROI) personalizada.
...
#' ALG_DESC: Baixa mapas LCZ dos EUA continentais. A função suporta cidades, estados, regiões ou áreas personalizadas.</p><p>
