...
##Modelling LCZ temperature=name
...
##Viogram_model=enum literal Sph;Exp;Gau;Ste Sph
...
if(Select_hour != "") { 
  ...
  # Directly convert to numeric range
    ...
    if (LCZ_interpolation) {
        Output=lcz_interp_map(LCZ_map, data_frame = my_table, var = Variable, station_id = Station_id,
