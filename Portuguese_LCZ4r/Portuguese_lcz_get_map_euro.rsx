...
#' City: String com o nome da cidade europeia (baseado em <a href='https://nominatim.openstreetmap.org/ui/search.html'>OpenStreetMap</a>).</p><p>Exemplo: <b>Berlim</b>. Se vazio, usa ROI personalizada.  
...
#' ALG_DESC: Baixa mapas LCZ europeus. Suporta cidades, regiões ou áreas personalizadas.</p><p>
